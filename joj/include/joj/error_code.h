...
namespace joj
{
    ...
    enum class ErrorCode
    {
        ...
        ERR_RENDERER_D3D11_VERTEX_BUFFER_CREATION,
        ERR_RENDERER_D3D11_INDEX_BUFFER_CREATION,
        ERR_RENDERER_D3D11_CONSTANT_BUFFER_CREATION,

        ERR_SHADER_D3D11_VERTEX_CREATION,
        ERR_SHADER_D3D11_PIXEL_CREATION,
        ERR_SAMPLER_STATE_D3D11_CREATION,
        ERR_D3D11_INPUT_LAYOUT_CREATION,
    };
