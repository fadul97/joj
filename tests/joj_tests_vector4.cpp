...
{
    joj::Vector4 v(1.0f, 2.0f, 3.0f, 4.0f);
    assert(v.x == 1.0f && v.y == 2.0f && v.z == 3.0f && v.w == 4.0f);
}

JOJ_TEST(Operator_Addition)
{
    joj::Vector4 v1(1.0f, 2.0f, 3.0f, 4.0f);
    joj::Vector4 v2(4.0f, 5.0f, 6.0f, 7.0f);
    joj::Vector4 result = v1 + v2;
    assert(result.x == 5.0f && result.y == 7.0f && result.z == 9.0f && result.w == 11.0f);
}

JOJ_TEST(Operator_Subtraction)
{
    joj::Vector4 v1(5.0f, 7.0f, 9.0f, 11.0f);
    joj::Vector4 v2(4.0f, 5.0f, 6.0f, 7.0f);
    joj::Vector4 result = v1 - v2;
...
{
    joj::Vector4 v1(1.0f, 2.0f, 3.0f, 4.0f);
    joj::Vector4 v2(4.0f, 3.0f, 2.0f, 1.0f);
...
{
    joj::Vector4 v(1.0f, 2.0f, 3.0f, 4.0f);
    joj::Vector4 normalized = v.normalized();
...
JOJ_TEST(Equality_Function_Check)
{
    joj::Vector4 v1(1.0f, 2.0f, 3.0f, 4.0f);
    DirectX::XMFLOAT4 dxv2 = { 1.0f, 2.0f, 3.0f, 4.0f };
    assert(is_Vector4_equal_to_XMFLOAT4(v1, dxv2));
}
...
JOJ_TEST(Vector_Addition)
{
    ...
    joj::Vector4 jSum = v1 + v2;

    assert(is_Vector4_equal_to_XMFLOAT4(jSum, dxSum));
}

JOJ_TEST(Vector_Normalization)
{
    joj::Vector4 v(3.0f, 4.0f, 0.0f, 0.0f);
    DirectX::XMFLOAT4 dxv = v.to_XMFLOAT4();
    ...
    joj::Vector4 jNorm = v.normalized();

    assert(is_Vector4_equal_to_XMFLOAT4(jNorm, dxNorm));
}
